...
//			we put our new info to the rear/back 
			queueArray[i+1] = input; // i önce -1 ardýndan 1 olur
//			yani i önce 0'dan küçük oldu, ardýndan loop içerisinde 
//			break sta olduðundan 0'dan büyük oldu
...
//		ilk deðer için priorityInsert metodu üzerinden insert metodu çaðýrýlýr
